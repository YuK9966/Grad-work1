...
ActiveRecord::Schema[7.2].define(version: 2025_11_18_053945) do
  ...
  create_table "nailstocks", force: :cascade do |t|
    t.bigint "nail_item_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["nail_item_id"], name: "index_nailstocks_on_nail_item_id"
    t.index ["user_id"], name: "index_nailstocks_on_user_id"
  end
  ...
  add_foreign_key "nailstocks", "nail_items"
  add_foreign_key "nailstocks", "users"
